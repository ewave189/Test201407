...
namespace LTP.CodeBuild
{
    ...
    public class BuilderFrameOne : BuilderFrame
    {
        ...
        public BuilderFrameOne(IDbObject idbobj, string dbName, LTP.IBuilder.SimplePair  tableName, string modelName, 
        ...
        public string GetCode(string DALtype, bool Maxid, bool Exists, bool Add, bool Update, bool Delete, bool GetModel, bool List, string procPrefix)
        {
          ...
          //  strclass.AppendLine("using Maticsoft.DBUtility;//请先添加引用");
            ...
            strclass.AppendLine("");
            if (!string.IsNullOrEmpty(DALtype))
            {
                ...
                foreach (ColumnInfo obj in Keys)
                {
                    if (CodeCommon.DbTypeToCS(obj.TypeName) == "int")
                    {
                        ...
                        if (obj.IsPK)
                        {
                            ...
                            strclass.AppendSpaceLine(2, "{" + "\r\n");
                            strclass.AppendSpaceLine(2, "return " + DbHelperName + ".GetMaxID(\"" + keyname + "\", \"" + TableName.Name  + "\"); ");
                            strclass.AppendSpaceLine(2, "}");
                            break;
                        }
                    }
        ...
        private string CreatExistsSQL()
        {
            ...
            if (Keys.Count > 0)
            {
                ...
                strclass.AppendSpace(3, "strSql.Append(\"select count(1) from " + TableName.Name );
        ...
        private string CreatAddSQL()
        {
            ...
            strclass.Append(Space(3) + "strSql.Append(\"insert into [" + TableName.Name  + "](\");" + "\r\n");
        ...
        private string CreatUpdateSQL()
        {
            ...
            strclass.AppendSpaceLine(2, "{" );
            strclass.AppendSpaceLine(3, "StringBuilder strSql=new StringBuilder();" );
            strclass.AppendSpaceLine(3, "strSql.Append(\"update " + TableName.Name  + " set \");" );
            foreach (ColumnInfo field in Fieldlist)
                {
                    string columnName = field.ColumnName;
                    string columnType = field.TypeName;
        ...
        private string CreatDeleteSQL()
        {
            ...
            //else
            //{
                strclass.Append(Space(3) + "strSql.Append(\"delete from " + TableName.Name  + " \");" + "\r\n");
            //}
        ...
        {            
            ...
            strclass.Append(Space(3) + "strSql.Append(\" from " + TableName .Name + " \");" + "\r\n");
            if (LTP.CodeHelper.CodeCommon.GetWhereExpression(Keys).Length > 0)
            {
                strclass.Append(Space(3) + "strSql.Append(\" where " + LTP.CodeHelper.CodeCommon.GetWhereExpression(Keys) + ");" + "\r\n");
            }
        ...
        private string CreatGetModelSQL()
        {
            ...
            strclass.AppendSpaceLine(3, "strSql.Append(\" from " + TableName .Name + " \");");
        ...
        {            
            List<ColumnInfo> collist = dbobj.GetColumnList(DbName, TableName.Name );
        ...
        private string CreatExistsProc()
        {
            ...
            strclass.AppendSpaceLine(3, "int result= " + DbHelperName + ".RunProcedure(\"UP_" + TableName.Name + "_Exists\",parameters,out rowsAffected);");
        ...
        {           
            ...
            strclass.AppendSpaceLine(3, "" + DbHelperName + ".RunProcedure(\"" + ProcPrefix + TableName.Name + "_ADD" + "\",parameters,out rowsAffected);");
            if ((dbobj.DbType == "SQL2000" || dbobj.DbType == "SQL2005" || dbobj.DbType == "SQL2008") && (IsHasIdentity))
            {
        ...
        {        
            ...
            strclass.AppendLine("};");
            strclass.AppendLine(strclass2.Value);
            strclass.AppendSpaceLine(3, "" + DbHelperName + ".RunProcedure(\"" + ProcPrefix + TableName.Name  + "_Update" + "\",parameters,out rowsAffected);");
        ...
        private string CreatDeleteProc()
        {
            ...
            strclass.AppendSpaceLine(3, "" + DbHelperName + ".RunProcedure(\"" + ProcPrefix + TableName.Name  + "_Delete" + "\",parameters,out rowsAffected);");
        ...
        private string CreatConstructorProc()
        {
            ...
            strclass.AppendSpaceLine(3, "DataSet ds= " + DbHelperName + ".RunProcedure(\"" + "UP_" + TableName.Name  + "_GetModel" + "\",parameters,\"ds\");");           
            strclass.AppendSpaceLine(3, "if(ds.Tables[0].Rows.Count>0)");
            strclass.AppendSpaceLine(3, "{");
            foreach (ColumnInfo field in Fieldlist)
                {
        ...
        private string CreatGetModelProc()
        {
            ...
            strclass.AppendSpaceLine(3, "DataSet ds= " + DbHelperName + ".RunProcedure(\"" + ProcPrefix + TableName.Name  + "_GetModel" + "\",parameters,\"ds\");");           
            strclass.AppendSpaceLine(3, "if(ds.Tables[0].Rows.Count>0)");
            strclass.AppendSpaceLine(3, "{");
            foreach (ColumnInfo field in Fieldlist)
            {
        ...
        private string CreatGetListProc()
        {
            ...
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "return " + DbHelperName + ".RunProcedure(\"" + ProcPrefix + TableName.Name  + "_GetList" + "\",new SqlParameter[] { null },\"ds\");");
            strclass.AppendSpaceLine(2, "}");
            return strclass.Value;
        }
        /// <summary>
        ...
        private string CreatGetListByPageProc()
        {
            ...
            strclass.AppendSpaceLine(5, "};");
            strclass.AppendSpaceLine(3, "parameters[0].Value = \"" + this.TableName.Name  + "\";");
        ...
        private string CreatExistsParam()
        {
            ...
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "StringBuilder strSql=new StringBuilder();");
            strclass.AppendSpaceLine(3, "strSql.Append(\"select count(1) from " + TableName.Name  + "\");");
        ...
        private string CreatDeleteParam()
        {
            ...
            //else
            //{
                strclass.AppendSpaceLine(3, "strSql.Append(\"delete from " + TableName.Name  + " \");");
            //}
