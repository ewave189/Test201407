...
namespace LTP.CodeBuild
{
    ...
    public class BuilderFrameS3 : BuilderFrame
    {
        ...
        #region 构造
        public BuilderFrameS3(IDbObject idbobj, string dbName, LTP.IBuilder.SimplePair tableName, string modelName, string bllName, string dalName,
        ...
        public string GetSimpleModelCode()
        {
            LTP.BuilderModel.BuilderModel model = new LTP.BuilderModel.BuilderModel();
            model.ModelName = ModelName;
            model.NameSpace = NameSpace;
