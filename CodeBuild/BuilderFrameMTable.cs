...
namespace LTP.CodeBuild
{
    ...
    /// 表双层
    /// </summary>
    public class BuilderFrameMTable : BuilderFrame
    {
        ...
        #region 构造
        public BuilderFrameMTable(IDbObject idbobj, string dbName, LTP.IBuilder .SimplePair  tableName, string modelName, string bllName, string dalName,
        ...
        public BuilderFrameMTable(IDbObject idbobj, string dbName, string nameSpace, string folder, string dbHelperName)
        {
            dbobj = idbobj;
            _dbtype = idbobj.DbType;
            DbName = dbName;
        ...
        {
            LTP.BuilderModel.BuilderModelMTable model = new LTP.BuilderModel.BuilderModelMTable();
